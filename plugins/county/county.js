(function ($) {
    $.fn.county = function (options) {
        ...
        return this.each(function () {
            ...
            container.append('<span class="county-days-wrapper first"><span class="county-days">00</span></span><span class="county-hours-wrapper separator-left border-separator-right"><span class="county-hours">00</span></span><span class="county-minutes-wrapper separator-left separator-left"><span class="county-minutes">00</span></span><span class="county-seconds-wrapper separator-left last"><span class="county-seconds">00</span></span><div class="count_labels clear"><span class="county-label-days">Дни</span><span class="county-label-hours">Часы</span><span class="county-label-minutes">Мин</span><span class="county-label-seconds">Сек</span></div>');
